...
export class OtpPage implements OnInit {
  ...
  async resendOtp() {
    ...
    var response = this.actionType == "signup" ? await this.profileService.registrationOtp({ email: this.signupData.email }) : await this.profileService.generateOtp({ email: this.resetPasswordData.email });
    if (response) {
